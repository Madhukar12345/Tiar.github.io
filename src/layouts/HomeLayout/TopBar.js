    ...
    return (
      <Container maxWidth="lg" className="p-0">
        <Toolbar className={toolbar}>
          {femmecubatorLogo}
 <Typography style={{color:"white", marginLeft:"20px", fontWeight:"700", fontSize:"30px"}}>TIAR</Typography>
          ...
          >
            ...
            <Button variant="outlined" color="secondary" style={{background: `linear-gradient(92.23deg, #FF56F6 21.43%, #B936EE 50.63%, #3BACE2 100%, #406AFF 117.04%)` , fontSize:'18px', fontWeight:"700", fontFamily: "'Orbitron', sans-serif",width:"166px", height:"50px"}}> Connect</Button>
          </Grid>
